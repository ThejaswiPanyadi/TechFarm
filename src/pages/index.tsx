        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-16 pt-20 sm:pt-24 pb-12 sm:pb-16">
          <div className="w-full max-w-none sm:max-w-xl text-white">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link
                href="/machines"
                className="bg-yellow-400 text-black px-6 py-3 rounded-lg text-center font-medium w-full sm:w-auto"
              >
                🚜 {t("rentBtn")}
              </Link>
              ...
              <Link
                href="/marketplace"
                className="border border-white px-6 py-3 rounded-lg text-center w-full sm:w-auto"
              >
                🌱 {t("browseBtn")}
              </Link>
            </div>
